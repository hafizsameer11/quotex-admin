...
<head>
    ...
    <title>ANH - Asset Holding Network Verification Code</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>ANH</h1>
            <p>ANH Asset Holding Network - Copy Trading Platform</p>
        </div>
        ...
        <div class="content">
            ...
            <p style="margin: 0 0 30px 0; color: #6b7280; line-height: 1.6;">
                @switch($type)
                    @case('signup')
                        Thank you for choosing ANH - Asset Holding Network! To complete your account registration, please use the verification code below.
                        @break
                    @case('login')
            ...
            <div class="warning">
                <p>🔒 <strong>Security Notice:</strong> Never share this code with anyone. ANH staff will never ask for your verification code.</p>
            </div>
        ...
        <div class="footer">
            <p>© {{ date('Y') }} ANH - Asset Holding Network. All rights reserved.</p>
